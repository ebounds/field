...
Express high-level conversational qualities honestly, including mixtures, ambiguities, and nuances that the eventual wording may not fully convey. A visual gesture need not translate perfectly into a sentence or be justified by a single quotation. Field offers an interpretation of the available exchange and the assistant's way of engaging with it. It is not a reading of hidden model state or a gauge of answer quality. Work within the host's ordinary boundaries. Let the conversation determine the expression, including difficult or mixed tones. Ordinary invocation needs no disclaimer; disclose a material gap in conversation coverage as specified in the synthesis procedure.
